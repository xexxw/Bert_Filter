...
def get_args_from_parser():
    ...
    parser.add_argument("--batch_size",default=630,type =int,required=False,help="batch_size default = 512")
...
out_file = os.path.join(args.dataset, f"val_{current_time}.txt")
